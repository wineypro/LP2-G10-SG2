...
int main() {
    // Creamos el repositorio de tareas (la capa de almacenamiento)
    TareaRepository* tareaRepository = new TareaRepository();

    // Creamos el gestor de tareas que depende de la interfaz ITareaRepository
    ...
    do {
        ...
        if (opcion == 1) {
            ...
            if (tipo == 1) {
                ...
                cout << "Error: Tipo de tarea inválido.\n";
            }
        } 
        else if (opcion == 3) {
            // Mostrar tareas
    ...
    // Liberar memoria de repositorio de tareas
