...
public:
    Consulta(int _dniPaciente, string _fecha, string _notas)
        : dniPaciente(_dniPaciente), fecha(_fecha), notas(_notas) {}
...
public:
    ConsultaGeneral(int _dniPaciente, string _fecha, string _notas)
        : Consulta(_dniPaciente, _fecha, _notas) {}
    
    ~ConsultaGeneral(){}
    
    void mostrarInformacion() const override {
        cout << "Consulta General - Fecha: " << fecha 
             << ", Paciente DNI: " << dniPaciente 
             << "\nNotas: " << notas << endl;
    }
};

class ConsultaEspecialista : public Consulta {
private:
    string especialidad;

public:
    ConsultaEspecialista(int _dniPaciente, string _fecha, string _notas, string _especialidad)
        : Consulta(_dniPaciente, _fecha, _notas), especialidad(_especialidad) {}

    void mostrarInformacion() const override {
        cout << "Consulta Especialista (" << especialidad 
             << ") - Fecha: " << fecha 
             << ", Paciente DNI: " << dniPaciente 
             << "\nNotas: " << notas << endl;
    }
